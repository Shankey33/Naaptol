...
const handleRemoveItem = (id) => {
  ...
  return (
            ...
            <div className="flex-1 sm:ml-4 flex flex-col justify-between">
                ...
                <div className="mb-2">
                    <span className="font-bold text-green-700 mr-2">₹ {Math.floor(((item.price) * item.quantity) - (item.discount/100 * item.price * item.quantity))} </span>
                    <span className="text-sm text-gray-500 line-through">₹ {(item.price) * item.quantity}</span>
